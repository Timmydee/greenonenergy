...
export default function AdminAddProduct({ onClose }: AddProductProps) {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mt-4">
            ...
            <select
              {...register("category")}
              onChange={(e) =>
                setCategory(e.target.value as "Inverter" | "Solar Panel")
              }
            >
          ...
          <button
            type="submit"
            disabled={
              updateProductMutation.isPending || uploadImagesMutation.isPending
            }
